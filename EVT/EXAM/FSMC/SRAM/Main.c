...
/*
 *@Note
 *   FSMCFSMC routine to operate NOR_ SRAM:
 *    This routine demonstrates the operation of IS62WV25616BLL model NOR_SRAM 
 *		erase-read through FSMC interface.
 *PIN:
 ...
 *    FSMC_A17--PD12
 *
 *    Note: The address line and data line of this routine are multiplexed 
