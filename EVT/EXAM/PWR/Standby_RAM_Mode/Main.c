 ...
 *This routine demonstrates writing data at the specified location of 2K RAM and 30K RAM, and then WFI 
 *enters STANDBY sleep mode, through the PA0 (wakeup) pin Input high level to exit standby mode, print 
 *RAM data after waking up, and test whether RAM is maintained data.
 *
 */
...
void TestDataWrite( void )
{
    ...
    uint32_t myAddr2 = 0x20000000 + 5 * 1024 + 512;
    uint32_t i = 0;
