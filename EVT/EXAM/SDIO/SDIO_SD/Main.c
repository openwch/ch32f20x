 ...
 *    This example demonstrates reading and writing all sectors of 
 *    the SD card through the SDIO interface.
 *DVP--PIN:
 *    D0--PC8
 *    D1--PC9
 *    D2--PC10
 ...
 *    SCK--PC12
 *    CMD--PD2
 *    Except for SCK, the rest need to pull up 47K resistors
 *
 */
