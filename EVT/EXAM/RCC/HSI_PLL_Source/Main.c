 ...
 *This example demonstrates that HSI or HSI/2 is used as the PLL input clock, and the system clock uses the PLL as the clock source.
 *Refer to system_ch32f20x.c, system_ch32f20x.h.
