 ...
 *level triggers EXTI line 15 event, in this mode, an ADC conversion is triggered by 
 *EXTI line 15 event, and a JEOC interrupt is generated after the conversion is completed.
 */
