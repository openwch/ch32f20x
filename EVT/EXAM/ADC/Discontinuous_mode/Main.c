 ...
 *and channel 4(PA4)- injection group channel. In this mode, once ADC conversion is triggered
 *by TIM1_CC4 event, and the above-mentioned injection group channels are sequentially 
 *converted each time.
 *
 */
