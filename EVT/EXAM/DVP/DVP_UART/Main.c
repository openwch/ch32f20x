 ...
 *or take 0xFF from a frame of data, starting with 0xD8;0xFF, data at the end of 0xD9, modify 
 *the file format to display pictures.
 *DVP--PIN:
 *    D10--PD6
 *    D11--PD2
 *    D8--PC10
 ...
 *   SYNC--PA5
 *
 *    Note: Use UART2 (PA2) serial port output, #define DEBUG DEBUG_UART2 in debug.h
