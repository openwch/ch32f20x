/********************************** (C) COPYRIGHT *******************************
* File Name          : ch32f20x_usbfs_device.c
* Author             : WCH
* Version            : V1.0.0
* Date               : 2022/08/20
...
__attribute__ ((aligned(4))) uint8_t USBFS_EP3_Buf[ DEF_USB_EP3_FS_SIZE*2 ];  //ep3_out(64)+ep3_in(64)
__attribute__ ((aligned(4))) uint8_t USBFS_EP4_Buf[ DEF_USB_EP4_FS_SIZE*2 ];  //ep4_out(64)+ep4_in(64)
__attribute__ ((aligned(4))) uint8_t USBFS_EP5_Buf[ DEF_USB_EP5_FS_SIZE*2 ];  //ep5_out(64)+ep5_in(64)
__attribute__ ((aligned(4))) uint8_t USBFS_EP6_Buf[ DEF_USB_EP6_FS_SIZE*2 ];  //ep6_out(64)+ep6_in(64)
 ...
 * @return  none
 */
void USBHD_Sleep_Wakeup_Operate( void )
{
    /* Code About USBHD Wakeup operation here */
}
