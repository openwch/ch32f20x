 ...
 *        structure.
 *          The TIM5 of CH32F20x_D8W is 32bit,Other MCU TIM5 is 16bit.
 *
 * @return  none
 */
 ...
 *
 * @brief   Initializes the CH32F20x_D8W TIM5 Time Base Unit peripheral according to
 *        the specified parameters in the TIM5_TimeBaseInitStruct.
 *
 ...
 * @fn      TIM5_OC1Init
 *
 * @brief   Initializes the CH32F20x_D8W TIM5 Channel1 according to the specified
 ...
 * @fn      TIM5_OC2Init
 *
 * @brief   Initializes the CH32F20x_D8W TIM5 Channel2 according to the specified
 *        parameters in the TIM5_OCInitStruct.
 *
 * @param   TIMx - where x can be 5 to select the TIM peripheral.
 *          TIM5_OCInitStruct - pointer to a TIM5_OCInitTypeDef structure.
 ...
 * @fn      TIM5_OC3Init
 *
 * @brief   Initializes the CH32F20x_D8W TIM5 Channel3 according to the specified
 *        parameters in the TIM5_OCInitStruct.
 *
 * @param   TIMx - where x can be 5 to select the TIM peripheral.
 *          TIM5_OCInitStruct - pointer to a TIM5_OCInitTypeDef structure.
 ...
 * @fn      TIM5_OC4Init
 *
 * @brief   Initializes the CH32F20x_D8W TIM5 Channel4 according to the specified
 *        parameters in the TIM5_OCInitStruct.
 *
 * @param   TIM5 - where x can be 5 to select the TIM peripheral.
 *          TIM5_OCInitStruct - pointer to a TIM5_OCInitTypeDef structure.
 *
 * @return  none
 */
 ...
 *
 * @brief   Fills each CH32F20x_D8W TIM5_TimeBaseInitStruct member with its default value.
 *
...
{
    TIM5_TimeBaseInitStruct->TIM_Period = 0xFFFFFFFF;
 ...
 *
 * @brief   Fills each CH32F20x_D8W TIM5_OCInitStruct member with its default value.
 *
 ...
 * @fn      TIM5_SetCounter
 *
 * @brief   Sets the CH32F20x_D8W TIM5 Counter Register value.
 *
 ...
 * @fn      TIM_SetAutoreload
 *
 * @brief   Sets the CH32F20x_D8W TIM5 Autoreload Register value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *          Autoreload - specifies the Autoreload register new value.
 *
 ...
 * @fn      TIM5_SetCompare1
 *
 * @brief   Sets the CH32F20x_D8W TIM5 Capture Compare1 Register value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *          Compare1 - specifies the Capture Compare1 register new value.
 *
 ...
 * @fn      TIM5_SetCompare2
 *
 * @brief   Sets the CH32F20x_D8W TIM5 Capture Compare2 Register value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *          Compare2 - specifies the Capture Compare2 register new value.
 *
 ...
 * @fn      TIM5_SetCompare3
 *
 * @brief   Sets the CH32F20x_D8W TIM5 Capture Compare3 Register value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *          Compare3 - specifies the Capture Compare3 register new value.
 *
 ...
 * @fn      TIM5_SetCompare4
 *
 * @brief   Sets the CH32F20x_D8W TIM5 Capture Compare4 Register value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *          Compare4 - specifies the Capture Compare4 register new value.
 *
 ...
 * @fn      TIM5_GetCapture1
 *
 * @brief   Gets the CH32F20x_D8W TIM5 Input Capture 1 value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *
 ...
 * @fn      TIM5_GetCapture2
 *
 * @brief   Gets the CH32F20x_D8W TIM5 Input Capture 2 value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *
 ...
 * @fn      TIM5_GetCapture3
 *
 * @brief   Gets the CH32F20x_D8W TIM5 Input Capture 3 value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *
 ...
 * @fn      TIM5_GetCapture4
 *
 * @brief   Gets the CH32F20x_D8W TIM5 Input Capture 4 value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *
 ...
 * @fn      TIM5_GetCounter
 *
 * @brief   Gets the CH32F20x_D8W TIM5 Counter value.
 *
 * @param   TIMx - where x can be 5 select the TIM peripheral.
 *
